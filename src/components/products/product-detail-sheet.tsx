  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hide">
      ...
      <div className="p-4 sm:p-6 space-y-3">
        ...
        {/* Product Options - "Out of stock" on individual option cards */}
        {hasOptions && (
        ...
        {/* Simple out of stock message */}
        {isOutOfStock && (
          <p className="text-sm text-red-500 text-center font-medium">
            {hasOptions ? 'Selected option is out of stock' : 'This product is currently out of stock.'}
          </p>
        )}
      </div>
    </div>
