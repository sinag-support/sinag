...
import { Plus, Search, Pencil, Trash2, Package, Layers, ChevronLeft, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-2xl w-[95vw] max-h-[90vh] overflow-y-auto scrollbar-hide">
          <DialogHeader>
